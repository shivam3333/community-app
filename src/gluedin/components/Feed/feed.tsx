  ...
  useEffect(() => {
      async function fetchData(page:any) {
          try {
            ...
            var feedModuleObj:any = new gluedin.GluedInFeedModule();
            var limit = 10;
            ...
            if (feedModuleResponse.status === 200) {
                ...
                console.log("homeFeeds ===", homeFeeds)
  ...
  if (!data) {
                        ...
                        <ul>
                            <li className="img-li">
                                <div className="img-holder">
                                    <a href={'profile.html?userId=' + contentInfo.user.userId}>
                            ...
                            <li>
                                <h3 className="ft-500">
                                    <a href={'profile.html?userId=' + contentInfo.user.userId}>{contentInfo.user.fullName}</a>
                ...
                <div className="post-slider-box-bottom">
                    <div className="strip">
                        <ul className="post-slider-box-bottom-ul">
                            ...
                            <li>
                                <a href={'content/' + contentInfoDetails.videoId} className="social-share-options">
    ...
    return (
        data.map((contentInfo:any)=>{
            return (
                <div className="full-post-box ordering" key={contentInfo._id}>
